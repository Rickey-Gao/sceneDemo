...
Page({
  ...
  routing: function (options){
    var _this = this;
    //options.longitude ， options.latitude  传入进来的参数：目的地址的经纬度
    //_this.data.longitude，_this.data.latitude 当前位置的经纬度
    let distance = Math.abs(_this.data.longitude - options.longitude) + Math.abs(_this.data.latitude - options.latitude)  //距离
